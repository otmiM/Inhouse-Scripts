#!/bin/bash
#SBATCH --job-name=CESA_using_VAC
...
#mpirun -n 1 /apps/gcc/12.2.0/openmpi/4.1.5/lammps/23Jun22el8/bin/lmp -echo screen -in remove_toluene.in
...
uniq \
     ...
     < system_1M.cav \
     > system_1M.unq
echo " duplicates are removed, 4th columns represent the radii of the spheres"
